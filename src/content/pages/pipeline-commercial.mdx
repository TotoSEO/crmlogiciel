...
featuredImage: /images/articles/pipeline-commercial.jpg
featuredImageAlt: "Entonnoirs reliés avec billes en mouvement, métaphore du pipeline commercial"
---
...
La règle qui change tout : **une étape se définit par son critère de sortie**, c'est-à-dire le fait vérifiable qui doit être vrai pour passer à la suivante. « Rendez-vous réalisé et besoin confirmé par le client », ça se constate. « Qualification en cours », ça se déclare. Quand chaque passage d'étape correspond à un fait, le pipeline devient lisible par tout le monde, y compris par celui qui ne connaît pas le dossier, et les probabilités retrouvent un sens. En amont même de la première étape, mieux vaut [qualifier vos prospects](/grille-qualification-bant/) : une affaire sans budget ni décideur n'a pas sa place dans le pipe.
...
Le bon test pour valider vos étapes : montrez votre pipeline à quelqu'un d'extérieur et demandez-lui de raconter où en est chaque affaire. S'il y arrive, la structure tient. Le pipeline vit ensuite jour après jour dans le [suivi commercial quotidien](/suivi-commercial/) : chaque affaire y garde une échéance à venir, ou elle n'est pas vraiment dans le pipe.
...
Vous trouverez en ligne des benchmarks de conversion par secteur ; je vous invite à ne pas les chercher. Ces moyennes mélangent des entreprises, des paniers et des définitions d'étapes qui n'ont rien à voir avec les vôtres : **vos taux historiques, même imparfaits, battent n'importe quel chiffre du marché**. La seule comparaison utile est la vôtre dans le temps, mois après mois, et c'est exactement ce que doivent montrer vos [indicateurs commerciaux](/tableau-de-bord-commercial/) : un pipeline pondéré (montant de chaque affaire multiplié par la probabilité de son étape) qui devient fiable à mesure que les probabilités viennent de votre historique plutôt que de l'optimisme ambiant.
