---
title: 'CRM et RGPD : bases légales, durées et conformité'
metaDescription: 'CRM et RGPD : bases légales, consentement, durées de conservation, registre des traitements, droits des personnes et paramétrage concret pour être conforme.'
h1: 'Rendre son CRM conforme au RGPD, concrètement'
excerpt: "Un CRM stocke des données personnelles : il relève du RGPD dès la première fiche. Voici les obligations qui comptent vraiment et comment les traduire dans le paramétrage de l'outil."
cluster: utiliser
type: satellite
datePublished: 2026-06-14
enBref:
  - "Un CRM traite des données personnelles : le RGPD s'applique dès le premier contact enregistré."
  - "Chaque donnée doit reposer sur une **base légale** : consentement, intérêt légitime ou exécution d'un contrat."
  - 'Les données ne se gardent pas indéfiniment : une durée de conservation se fixe et se tient, du prospect au client.'
  - 'Le **registre des traitements** est obligatoire, même pour une PME, et se résume à un tableau.'
  - "La conformité se règle surtout dans le paramétrage : droits d'accès, durées, traçabilité, export et suppression."
faq:
  - question: 'Sur quelle base légale faire de la prospection B2B ?'
    answer: "L'intérêt légitime, dans la plupart des cas : vous pouvez contacter un professionnel sur son adresse professionnelle pour une offre en lien avec son activité, à condition de l'informer et de lui laisser un moyen simple de s'opposer. La prospection par email vers des particuliers, elle, exige un consentement préalable. La frontière tient à la nature du destinataire, pas au canal."
  - question: "Combien de temps peut-on garder les données d'un client ?"
    answer: "Pendant toute la relation commerciale, puis le temps imposé par vos obligations légales : dix ans pour les pièces comptables, par exemple. Au-delà de l'usage actif, la donnée bascule en archivage à accès restreint, avant suppression. Un prospect sans réaction, lui, se conserve environ trois ans après le dernier contact."
  - question: "Qu'est-ce qu'un DPA, ou contrat de sous-traitance ?"
    answer: "C'est le contrat qui encadre la relation entre vous et l'éditeur de votre CRM, considéré comme sous-traitant de vos données. Il précise les finalités, les mesures de sécurité, le sort des données en fin de contrat et les conditions d'une éventuelle sous-traitance ultérieure. Un éditeur sérieux le fournit sans difficulté ; son absence ou son flou est un signal d'alarme."
  - question: 'Peut-on utiliser un CRM américain en restant conforme ?'
...
- **Les droits d'accès** : chaque utilisateur ne voit que les données utiles à son rôle. Un commercial n'a pas besoin de toute la base, et limiter les accès limite les risques.

- **Les durées et la purge** : configurez l'archivage ou la suppression automatique des fiches qui dépassent leur durée de conservation, plutôt que de compter sur un nettoyage manuel qui n'arrive jamais.

- **Le suivi du consentement** : un champ dédié, daté, qui enregistre l'accord de chaque contact et son origine. C'est lui qui vous permettra de prouver le consentement le jour où on vous le demandera.

- **La traçabilité** : activez le journal qui enregistre qui a consulté ou modifié quoi. Utile en cas d'incident, et dissuasif en interne.

- **La minimisation** : ne créez pas de champ que vous ne saurez pas justifier. Moins de données collectées, c'est moins de données à protéger.
