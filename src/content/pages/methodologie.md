...
enBref:
  - 'Nos verdicts reposent sur des tests réels, pas sur les fiches techniques des éditeurs.'
  - 'Cinq critères pondérés structurent chaque note : fonctionnel, coût, ergonomie, support, pérennité.'
  - 'Notre classement est indépendant : aucun éditeur ne peut acheter sa place.'
  - 'Pour tester un CRM vous-même, une règle prime : essayez avec vos vraies données et votre scénario réel.'
faq:
  - question: 'Les éditeurs peuvent-ils payer pour être mieux classés ?'
    answer: "Non, jamais. Le classement repose uniquement sur nos tests et notre grille de notation. Aucun éditeur ne nous rémunère, ni pour figurer dans nos pages, ni pour y être mieux placé. Un outil mal noté le reste, qu'il s'agisse d'une grande marque ou d'un parfait inconnu."
  - question: 'À quelle fréquence les tests sont-ils mis à jour ?'
    answer: "Le classement général est révisé chaque trimestre, et les prix chaque année. Nous reprenons aussi un test dès qu'un outil connaît une évolution majeure, comme un changement de tarifs ou une refonte de son interface."
  - question: 'Combien de temps faut-il pour bien tester un CRM ?'
