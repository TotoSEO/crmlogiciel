---
title: 'Les types de CRM : opérationnel, analytique, collaboratif'
metaDescription: "Opérationnel, analytique, collaboratif : la typologie expliquée avec des exemples concrets, et les distinctions (cloud, vertical) qui comptent vraiment à l'achat."
h1: 'Les différents types de CRM'
excerpt: "La typologie classique distingue trois types de CRM : opérationnel, analytique et collaboratif. Ce qu'elle décrit vraiment, comment ces couches se combinent, et les distinctions qui comptent à l'achat."
cluster: comprendre
type: satellite
datePublished: 2026-06-14
enBref:
  - "La typologie classique distingue trois types de CRM : **opérationnel** (agir au quotidien), **analytique** (comprendre les données), **collaboratif** (faire circuler l'information)."
  - 'Ces trois types décrivent des couches de fonctions, pas des produits : les outils modernes contiennent les trois, à des degrés divers.'
  - 'Le découpage date de la fin des années 1990 ; il reste utile pour comprendre, moins pour acheter.'
  - "Les distinctions qui comptent vraiment à l'achat : cloud ou installé chez vous, et généraliste ou vertical métier."
  - 'Pour réviser, retenez les trois types ; pour acheter, partez de votre besoin.'
faq:
  - question: "Qu'est-ce qu'un CRM opérationnel ?"
    answer: "C'est la couche d'un CRM qui exécute la relation client au quotidien : gestion des contacts, suivi des opportunités, automatisation des ventes, du marketing et du service. Elle s'adresse aux équipes de terrain et constitue le cœur de tous les outils du marché. Un CRM sans couche opérationnelle n'existe pas."
  - question: "Qu'est-ce qu'un CRM analytique ?"
