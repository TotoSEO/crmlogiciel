---
title: 'Lead scoring : définition, grille de points et méthode'
metaDescription: 'Le lead scoring expliqué simplement : à quoi il sert, la grille de points, les seuils qui déclenchent une action et comment la calibrer sur vos données.'
h1: 'Le lead scoring : noter ses prospects pour savoir qui appeler'
excerpt: 'Le lead scoring attribue des points à chaque prospect pour repérer ceux qui méritent un appel tout de suite. Voici comment bâtir une grille fiable, la relier à des actions et la calibrer sur vos propres données.'
cluster: utiliser
type: satellite
datePublished: 2026-06-14
enBref:
  - 'Le lead scoring note chaque prospect selon son profil (le fit) et ses actions (le comportement), pour traiter les bons en premier.'
  - "Il devient utile au-delà d'une cinquantaine de leads par mois. En dessous, un commercial fait aussi bien à l'œil."
  - 'Une grille efficace prévoit des points négatifs et une baisse du score avec le temps.'
  - 'Chaque seuil de score doit déclencher une action précise, sinon le chiffre ne sert à rien.'
  - 'La grille se calibre sur vos vraies affaires gagnées, pas sur un modèle copié en ligne.'
faq:
  - question: 'Quelle est la différence entre un MQL et un SQL ?'
    answer: "Le MQL, ou Marketing Qualified Lead, est un prospect qui a atteint le seuil de score le rendant digne d'un contact commercial. Le SQL, ou Sales Qualified Lead, est un prospect qualifié par un commercial après un premier échange : besoin réel, budget plausible, calendrier identifié. Le scoring fabrique des MQL. Seule une conversation transforme un MQL en SQL, et confondre les deux remplit le pipeline de dossiers vides."
  - question: 'À partir de quel score faut-il passer un lead aux commerciaux ?'
    answer: "Au score où votre taux de transformation décolle dans vos propres données, ce qui se repère en quelques minutes une fois trois mois d'historique accumulés. En attendant cet historique, placez un seuil provisoire là où un bon profil et au moins un signal d'intention fort se cumulent, puis ajustez au premier trimestre."
  - question: 'Le lead scoring est-il utile en petit volume ?'
    answer: "En dessous d'une cinquantaine de leads par mois, rarement. Chaque dossier peut être regardé par un humain, qui perçoit des nuances qu'aucune grille ne capte. Une exception : les points négatifs restent utiles même à petit volume, pour écarter d'office les profils hors cible sans y consacrer un appel."
  - question: 'Comment noter les leads qui arrivent hors ligne ?'
  ...
  - question: 'Faut-il montrer le score aux commerciaux ?'
...
| **Famille**  | **Critère**                                     |  **Points**  |
| :----------- | :---------------------------------------------- | :----------: |
| Fit          | Secteur dans votre cible                        |     +15      |
| Fit          | Taille d'entreprise dans votre cœur de marché   |     +10      |
| Fit          | Interlocuteur décideur ou prescripteur          |     +15      |
| Comportement | Demande de devis ou de démonstration            |     +30      |
| Comportement | Page tarifs consultée                           |     +15      |
| Comportement | Document téléchargé ou webinaire suivi          |     +10      |
| Comportement | Email ouvert puis cliqué                        |      +5      |
| Négatif      | Adresse email générique ou personnelle          |     -10      |
| Négatif      | Étudiant, demandeur d'emploi ou curieux déclaré |     -30      |
| Négatif      | Concurrent identifié                            |     -50      |
| Négatif      | Aucune activité depuis 30 jours                 | -15 par mois |
