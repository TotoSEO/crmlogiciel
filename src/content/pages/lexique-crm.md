---
title: 'Lexique du CRM : le vocabulaire à connaître simplement'
metaDescription: 'Lexique CRM : lead, pipeline, scoring, MQL, churn, CLV… toutes les définitions du vocabulaire CRM, claires et courtes, pour ne plus jamais être perdu en démonstration.'
h1: 'Le lexique du CRM : tout le vocabulaire, expliqué simplement'
excerpt: "Lead, pipeline, scoring, MQL, churn… le CRM a son jargon. Voici les définitions courtes et claires des termes que vous croiserez, du premier contact commercial à l'analyse de vos ventes."
cluster: comprendre
type: satellite
datePublished: 2026-06-14
enBref:
  - 'Le vocabulaire CRM se range en quelques familles : les contacts, la vente, le marketing, les données.'
  - "Un lead n'est pas un prospect, un MQL n'est pas un SQL : ces nuances changent la façon de travailler."
  - 'Les termes les plus importants comme le pipeline, le scoring ou la segmentation ont chacun leur guide détaillé.'
  - 'Pas besoin de tout retenir : gardez cette page sous la main pour vos démonstrations.'
faq:
  - question: 'Quelle est la différence entre un lead et un prospect ?'
    answer: "Un lead est une piste brute : un contact qui a montré un signe d'intérêt, sans plus. Un prospect est un lead qualifié, dont on a vérifié qu'il correspond à une cible et qu'il a un potentiel d'achat réel. On transforme donc un lead en prospect en le qualifiant."
  - question: 'MQL ou SQL : comment les distinguer ?'
    answer: "Un MQL est validé par le marketing sur la base d'un comportement : il a téléchargé, visité ou ouvert vos messages. Un SQL est validé par les commerciaux comme prêt à être contacté pour vendre. Le MQL devient SQL quand la vente estime qu'il mérite son temps. C'est le point de passage entre les deux équipes."
  - question: 'Faut-il connaître tout ce vocabulaire pour utiliser un CRM ?'
