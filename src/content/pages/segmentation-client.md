...
On regroupe ici selon les actes : produits achetés, fréquence d'usage, pages consultées, emails ouverts, dernière commande. C'est la méthode la plus prédictive, parce que **le comportement d'hier annonce mieux l'achat de demain** que la taille de l'entreprise. À ne pas confondre avec le [lead scoring](/lead-scoring/), qui note des prospects individuellement pour décider d'un passage à l'action commerciale : la segmentation fabrique des groupes durables, le scoring classe des individus à un instant donné.
